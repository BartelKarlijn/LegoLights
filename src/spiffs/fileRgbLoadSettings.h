...
// Load all Rgb settings into memory
  ...
  if (!SPIFFS.exists(filename)) {
    ...
    for (uint8_t rgbnr=0; rgbnr<jrgbarr.size(); rgbnr++) {
      rgbsettings[rgbnr].rgbdesc          = jrgbarr[rgbnr]["rgbdesc"].as<String>();
      rgbsettings[rgbnr].rgbimage         = jrgbarr[rgbnr]["rgbimage"].as<String>();
      rgbsettings[rgbnr].startrgb         = jrgbarr[rgbnr]["startrgb"].as<uint8_t>();
      rgbsettings[rgbnr].stoprgb          = jrgbarr[rgbnr]["stoprgb"].as<uint8_t>();
      ...
      for (uint8_t animnr=0; animnr<janimarr.size(); animnr++) {
        rgbsettings[rgbnr].anim[animnr].hue1        = janimarr[animnr]["hue1"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].sat1        = janimarr[animnr]["sat1"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].bri1        = janimarr[animnr]["bri1"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].hue2        = janimarr[animnr]["hue2"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].sat2        = janimarr[animnr]["sat2"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].bri2        = janimarr[animnr]["bri2"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].hue3        = janimarr[animnr]["hue3"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].sat3        = janimarr[animnr]["sat3"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].bri3        = janimarr[animnr]["bri3"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].hue4        = janimarr[animnr]["hue4"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].sat4        = janimarr[animnr]["sat4"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].bri4        = janimarr[animnr]["bri4"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].every       = janimarr[animnr]["every"].as<uint8_t>();
        rgbsettings[rgbnr].anim[animnr].timeon      = janimarr[animnr]["timeon"].as<unsigned long>();
        rgbsettings[rgbnr].anim[animnr].timeoff     = janimarr[animnr]["timeoff"].as<unsigned long>();
        rgbsettings[rgbnr].anim[animnr].timeeffect  = janimarr[animnr]["timeeffect"].as<long>();
        rgbsettings[rgbnr].anim[animnr].seed        = janimarr[animnr]["seed"].as<int8_t>();      //accepting negative values
        rgbsettings[rgbnr].anim[animnr].effect      = janimarr[animnr]["effect"].as<uint8_t>();
        regelcounter++; 
      }
